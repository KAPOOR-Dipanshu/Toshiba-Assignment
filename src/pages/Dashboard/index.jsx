    ...
    <>
      <div className="bg-gray-100 flex sm:flex-col md:flex-col flex-row font-inter gap-4 items-start justify-start mx-auto p-4 w-auto sm:w-full md:w-full">
        <Sidebar
          ...
          className="!sticky !w-[280px] flex h-screen md:hidden justify-start overflow-auto md:px-5 top-[0] bg-white-A700 rounded-xl"
        >
          <Menu
            menuItemStyles={{
              button: {
            ...
            className="flex flex-col items-center justify-start mb-[35px] pt-[11px] px-5 w-[80%]"
          >
            <div className="sm:h-[393px] md:h-[449px] h-[440px] relative w-full">
              <div className="absolute flex flex-row justify-start pb-4 pt-4 w-60">
                <Img
                  className="h-10 w-60"
              ...
              <div className="absolute bottom-[0] flex flex-col gap-2 inset-x-[0] items-center justify-start mx-auto p-2 w-full">
                <MenuItem>
                  <div className="flex flex-col items-center justify-start">
                    <div className="flex flex-row gap-2 justify-start px-2 py-3 w-full">
                      <Img
                        className="h-4 w-4"
                ...
                <div className="flex flex-col justify-start w-full">
                  <div className="flex md:flex-col flex-row h-[41px] md:h-auto justify-start py-3 rounded-[20px] w-60">
                    <Img
                      className="h-4 w-16"
            ...
            <div className="flex sm:flex-col flex-row h-30 md:h-auto justify-start mt-20 w-full">
              <div className="flex px-3  flex-col justify-start">
                <Img
                  className="h-8 md:h-auto rounded-[50%] "
                  src="images/img_rectangle1.png"
                  alt="rectangleOne"
                />
              </div>
              <div className="flex flex-1 md:flex-1 flex-col gap-1 items-start w-auto md:w-full">
                <Text
                  className="text-gray-900 text-left tracking-[-0.25px]"
        ...
        <div className="flex flex-1 flex-col gap-4 h-full items-start justify-start md:px-5 w-full">
            ...
            <div className="bg-white-A700 flex flex-col gap-2 h-[261px] md:h-auto items-center justify-start p-6 sm:px-5 rounded-[16px] w-[260px]">
              ...
              <div className="flex flex-col items-center justify-start w-full">
                <div className="h-[102px] relative w-full">
                  ...
                  />
                  <div
                    className="absolute bg-cover bg-no-repeat flex flex-col h-full items-center justify-center my-auto pt-[51px] md:px-10 sm:px-5 px-[51px]"
                    style={{ backgroundImage: "url('images/img_group23.svg')" }}
                  >
                    <Text
                      className="mt-[11px] md:text-3xl sm:text-[18px] text-[32px] text-center text-gray-900 tracking-[-1.59px]"
          ...
          <div className="flex md:flex-col flex-row gap-4 items-start justify-start w-full">
            ...
            <div className="flex flex-1 flex-col gap-4 h-[400px] md:h-auto items-start justify-start w-full">
              <div className="bg-white-A700 flex flex-col gap-2 items-start justify-start p-6 sm:px-5 rounded-[16px] w-full">
              ...
              <List
                className="sm:flex-col flex-row gap-4 grid sm:grid-cols-1 grid-cols-3 h-full justify-start w-full "
                orientation="horizontal"
              >
                <div className="bg-white-A700 flex flex-1 flex-col gap-3 items-start justify-start p-3 mb-7 rounded-[16px] w-full">
                  <Text
                ...
                <div className="bg-white-A700 flex flex-1 flex-col gap-3 h-auto items-start justify-start p-3 mb-7 rounded-[16px] w-full">
                  <Text
                    className="text-base text-gray-600 tracking-[-0.40px] w-auto"
                    size="txtInterSemiBold16"
                  >
          ...
          <div className="flex md:flex-col flex-row gap-4 items-start justify-start w-full">
            ...
            <div className="bg-white-A700 flex flex-col gap-2 h-64 md:h-auto items-start justify-start p-6 sm:px-5 rounded-[16px]">
              ...
              <div className="bg-gradient flex flex-row gap-2 items-start justify-between px-2 py-1.5 rounded w-full">
                <Text
                ...
                <Text
                  className="text-[10px] text-gray-900 text-sm uppercase w-auto"
                  size="txtInterMedium10Gray900"
                >
                  120k
                </Text>
              </div>
              <div className="bg-gradient  flex flex-row gap-2 items-start justify-between px-2 py-1.5 rounded w-[229px]">
                <Text
                  className="text-gray-900 text-sm uppercase w-auto"
                  size="txtInterSemiBold14"
                >
              ...
              <div className="bg-gradient  flex flex-row gap-2 items-start justify-between px-2 py-1.5 rounded w-[207px]">
                <Text
                  className="text-gray-900 text-sm uppercase w-auto"
                  size="txtInterSemiBold14"
                >
              ...
              <div className="bg-gradient  flex flex-row gap-2 items-start justify-between px-2 py-1.5 rounded w-[150px]">
                <Text
                  className="text-gray-900 text-sm uppercase w-auto"
                  size="txtInterSemiBold14"
                >
            ...
            <div className="bg-white-A700 flex flex-1 flex-col gap-2 h-full items-start justify-start p-6 sm:px-5 rounded-[16px] w-full">
              ...
              <div className="flex flex-col items-end justify-start w-full">
                <div className="flex flex-col gap-2 items-start justify-start w-full">
                  <div className="flex sm:flex-col flex-row items-center justify-between w-full">
                    <Button
